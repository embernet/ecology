---
title: "Year 1: Seasonal changes"
slug: "year-1-seasonal-changes"
---

## Seasonal Changes

<Requirement id={`q11`} text={`- observe changes across the four seasons
- observe and describe weather associated with the seasons and how day length varies.`} />


<br />
<Guidance id={`g6`} text={`Pupils should observe and talk about changes in the weather and the seasons.
...
<Ref>*[National Curriculum in England: primary curriculum](https://www.gov.uk/government/publications/national-curriculum-in-england-primary-curriculum)*, Section: "Seasonal changes", p. 150.</Ref>

## The Four Seasons

<Note id={`t15`} title={`What Are Seasons?`} text={`The year is split into four parts called seasons. Each season brings changes in the weather, how long the days are, and what plants and animals do. It's like the Earth has four different outfits it wears each year!`} />
...
<NatureExample id={`n85`} 
  title={`Spring`} 
  emoji={`🌸`} 
  facts={`- Many farm animals, like sheep and cows, give birth to their babies in the spring.
...
>
<WikiImage filename="Spring with Flowers.jpg" alt="Spring flowers" />
...
<Note id={`t16`} title={`Waking Up!`} text={`Spring is when the weather gets warmer, the days get longer, and the world turns green again. For animals, it's time to wake up, find a partner, and have babies.`} />
...
>
<WikiImage filename="Frog spawn - geograph.org.uk - 6418542.jpg" alt="Frog spawn" />
...
>
<WikiImage filename="Blue Tit @ nest box 02.06.11 (5790732023).jpg" alt="A blue tit bringing food to its nest box" />
...
>
<WikiImage filename="Boxing hares! (49898514632).jpg" alt=" Boxing hares!" />
...
<NatureExample id={`n89`} 
  title={`Summer`} 
  emoji={`☀️`} 
  facts={`- The longest day of the year happens in summer and is called the Summer Solstice.
...
>
<WikiImage filename="Late summer pollination.jpg" alt="Late summer bee pollination" />
...
<Note id={`t17`} title={`Raising Families`} text={`Summer is the warmest time of year with the longest days. There is plenty of food, making it the perfect time for animals to raise their babies.`} />
...
>
<WikiImage filename="Common Swift 2025 07 18 02.jpg" alt="Common Swift in flight" />
...
>
<WikiImage filename="Common Green Grasshopper. Omocestus viridulus, female (51706721183).jpg" alt="A common green grasshopper" />
...
>
<WikiImage filename="Pipistrellus pipistrellus.jpg" alt="A tiny pipistrelle bat, small enough to fit in a matchbox" />
...
<NatureExample id={`n93`} 
  title={`Autumn`} 
  emoji={`🍂`} 
  facts={`- The changing colours of the leaves are caused by the trees stopping making chlorophyll (the stuff that makes them green).
...
>
<WikiImage filename="Autumn in Scarva - geograph.org.uk - 603232.jpg" alt="Autumn leaves change colour and fall" />
...
<Note id={`t18`} title={`Getting Ready for Winter`} text={`In autumn, the days get shorter and the weather gets cooler. For animals, this is a very busy time. They need to get ready for the cold winter when there won't be much food.`} />
...
>
<WikiImage filename="Eastern Grey Squirrel in St James's Park, London - Nov 2006 edit.jpg" alt="A grey squirrel eating a nut in St. James's Park" />
...
>
<WikiImage filename="Hedgehog at Forest How (15194383706).jpg" alt="Hedgehog out at night" />
...
>
<WikiImage filename="Hirundo rustica Ormoz.jpg" alt="Barn swallow perched on a wire" />
...
<NatureExample id={`n97`} 
  title={`Winter`} 
  emoji={`❄️`} 
  facts={`- The shortest day of the year is in winter and is called the Winter Solstice.
...
>
<WikiImage filename="A winter robin - geograph.org.uk - 6737906.jpg" alt="A winter robin finds some berries to eat" />
...
<Note id={`t19`} title={`Surviving the Cold`} text={`Winter is the hardest time for animals. It is cold and dark, and food is very hard to find. Animals have clever ways to survive.`} />
...
>
<WikiImage filename="European robin (Erithacus rubecula) singing 3.jpg" alt="Robin singing" />
...
>
<WikiImage filename="Common frog (Rana temporaria).jpg" alt="A common frog sitting in shallow water" />
...
>
<WikiImage filename="Ladybirds emerge from hibernation by telegraph pole (23903082068).jpg" alt="A cluster of ladybirds emerge from hibernation" />
<WikiImage filename="Close-up of a mass gathering of ladybugs near the peak of Glorieta Baldy north of Glorieta, New Mexico on 29 August, 2022.jpg" alt="A mass gathering of ladybirds on a tree in New Mexico getting ready for hibernation" />
...
<Activity id={`a33`} 
      title={`Seasonal Wheel`} 
      description={`Give each pupil a paper plate and help them divide it into four sections. They can then draw or stick pictures in each section to show the four different seasons.`} 
    />



<Activity id={`a34`} 
      title={`A Weekly Weather Diary`} 
      description={`Create a simple chart for the classroom wall with the days of the week. Each day, choose a pupil to be the 'weather watcher' who draws a picture of the weather (e.g., a sun, a cloud, raindrops) and sticks it on the chart.`} 
    />
...
<Activity id={`a35`} 
      ...
      description={`Give pupils a template of a bare tree. They can decorate the tree to show what it would look like in each of the four seasons. For example, pink tissue paper for spring blossom, green leaves for summer, orange and red leaves for autumn, and cotton wool for winter snow.`} 
    />
...
<Reflection id={`r37`} 
      ...
      description={`Ask pupils to draw a picture of their favourite season and one thing they like to do in it.`} 
    />
...
<Reflection id={`r38`} 
      ...
      description={`In pairs, ask pupils to talk about what clothes they would wear on a hot summer day and what clothes they would wear on a cold winter day. Why are they different?`} 
    />
...
<Reflection id={`r39`} 
      ...
      description={`In small groups, pupils can discuss: *What do you think a squirrel does with all the nuts it collects in autumn? Why does it need them?*`} 
    />
...
<Reflection id={`r40`} 
      ...
      description={`As a class, look out of the window or think about what it was like on the way to school. Ask: *What season are we in now? What clues can you see, hear, or feel that tell you this?*`} 
    />
