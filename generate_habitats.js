...
<Guidance id="g_${h.id}_1" title="${h.cat} Habitats" text="${h.desc} This page is part of our GCSE Natural History preparation, focusing specifically on UK native species and environments." />
...
<Activity id="a_${h.id}_1" title="Spot the ${h.cat} Wildlife" emoji="🔍" description="Can you find three different types of plants or animals the next time you visit a ${h.cat} habitat? Record them in your Field Journal!" />

## Outdoor Observation

<Activity id="a_${h.id}_2" title="10-Minute ${h.cat} Survey" emoji="⏱️" description="Sit quietly in this habitat for 10 minutes. Write down everything you hear, see, and smell. What is the most abundant species?" />
