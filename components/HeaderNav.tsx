        ...
        <div className="about-modal-backdrop" onClick={() => setShowAbout(false)}>
          <div className="about-modal" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="About">
            ...
            <p className="about-modal-message">
              Feel free to connect with me if you have ideas about how to improve this website.
            </p>

            <p className="about-modal-message about-modal-licence">
              This site is free to use under the <strong>MIT open source licence</strong>. You can use it directly here or copy it and use it as the basis for your own ecology site.
            </p>
